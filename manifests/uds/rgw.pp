class ceph::uds::rgw (
 ...
 #   require ::sunfire::ceph::params
    ...
    ceph_config {
      "client.radosgw.${rgw_name}/admin_socket": value => $::ceph::uds::params::rgw_admin_socket;
      ...
      "client.radosgw.${rgw_name}/rgw_enable_usage_log": value => $::ceph::uds::params::rgw_enable_usage_log;
      "client.radosgw.${rgw_name}/rgw_override_bucket_index_max_shards": value => $::ceph::uds::params::rgw_override_bucket_index_max_shards;
      "client.radosgw.${rgw_name}/rgw_cache_enabled": value => $::sunfire::storage::storage::ceph::params::rgw_cache_enabled;
      "client.radosgw.${rgw_name}/rgw_cache_lru_size": value => $::ceph::uds::params::rgw_cache_lru_size;
      "client.radosgw.${rgw_name}/rgw_num_rados_handles": value => $::ceph::uds::params::rgw_num_rados_handles;
      "client.radosgw.${rgw_name}/rgw_swift_token_expiration": value => $ceph::uds::params::rgw_swift_token_expiration;
      "client.radosgw.${rgw_name}/rgw_thread_pool_size": value => $::ceph::uds::params::rgw_thread_pool_size;
    }

    if $rgw_s3_auth_use_keystone {
      ceph_config {
          "client.radosgw.${rgw_name}/nss_db_path": value => $ceph::uds::params::nss_db_path;
          ...
          "client.radosgw.${rgw_name}/rgw_keystone_token_cache_size": value => $::ceph::uds::params::rgw_keystone_token_cache_size;
          "client.radosgw.${rgw_name}/rgw_keystone_revocation_interval": value => $::ceph::uds::params::rgw_keystone_revocation_interval;
      }
    } else {
      ceph_config {
